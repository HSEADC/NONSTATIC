...
function _handleSubmit() {
  _handleSubmit = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var status, button, collectEmails, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          collectEmails = document.querySelector('.collectEmails');
...
var scrollIncrementIndex = 1;
var preview = document.querySelector('.preview');
if (preview) {
  scrollIncrementIndex = 4;
}
var paths = document.querySelectorAll('.scrollLine');
var scrollContainer = document.getElementById('scrollContainer');
var currentTextIndex = 3;
...
window.addEventListener('scroll', function () {
  paths.forEach(function (path) {
    ...
    var drawLength = pathLength * scrollPercentage * scrollIncrementIndex;
